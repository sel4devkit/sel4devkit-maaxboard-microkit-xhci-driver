#include <sddf/fs/fat/FiberPool/FiberFlow/FiberFlow.h>
#include <sddf/fs/fat/libfssharedqueue/fs_shared_queue.h>
...
void test() {
    ...
    strcpy(line, "Hello! This is my AsyncFatfs 123?!");
