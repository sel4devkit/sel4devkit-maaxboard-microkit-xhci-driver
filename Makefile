...
NETBSD_SRC			:=  dev_verbose.o subr_device.o subr_autoconf.o usbdi_util.o usbdi.o usbroothub.o sel4_bus_funcs.o dma.o usb.o usb_quirks.o usb_subr.o xhci.o usb_mem.o uhub.o hid.o uhidev.o ukbd.o hidkbdmap.o ioconf.o uhid.o ums.o uts.o
UTILS				:= 	tinyalloc.o printf.o util.o timer.o

XHCI_STUB_OBJS 		:=  xhci_stub.o $(NETBSD_SRC) imx8mq_usbphy.o dwc3_fdt.o $(UTILS)
PIPE_HANDLE_OBJS 	:=  pipe_handler.o $(NETBSD_SRC) $(UTILS)
...
SOFTWARE_OBJS 		:=  software_interrupts.o $(NETBSD_SRC) $(UTILS)
